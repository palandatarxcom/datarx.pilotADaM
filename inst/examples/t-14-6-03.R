...
#' gen_ht_t14_603
#'
#' Generate Table 14-6.03 Frequency of Normal and Abnormal (Clinically Significant Change from Previous Visit) Laboratory Values During Treatment
#'
#' Got errors
#'
#' @param adlbc
...
#' @examples
#'
gen_ht_t14_603 <- function(adlbc, adlbhpv, adsl) {
  ...
  adlbc3 <- adlbc2 |>
    ...
    tidyr::pivot_wider(id_cols = PARAM,names_from = c(TRTP, ANRIND), values_from = n_w_pct) |>
...
ht <- gen_ht_t14_603(adam_adlbc, adam_adlbhpv, adam_adsl)
