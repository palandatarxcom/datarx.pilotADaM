...
#' @format a data frame with 961 rows and 37 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
...
#' @format a data frame with 7510 rows and 23 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @format a data frame with 596 rows and 15 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @format a data frame with 591 rows and 18 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_lbch
#' @description Laboratory Chemistry Tests Results data frame - One record per analyte per planned time point number per time point reference per visit per subject
#' @format a data frame with 32740 rows and 24 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_lbhe
#' @description Laboratory Hematology Tests Results data frame - One record per analyte per planned time point number per time point reference per visit per subject
#' @format a data frame with 21927 rows and 24 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_lbur
#' @description Laboratory Urinalysis Tests Results data frame - One record per analyte per planned time point number per time point reference per visit per subject
#' @format a data frame with 4913 rows and 24 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @format a data frame with 1817 rows and 19 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_qsco
#' @description Questionnaires Alzheimer's Disease Assessment Scale-Cognitive data frame - One record per questionnaire per question per time point per visit per subject
#' @format a data frame with 12241 rows and 23 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_qsda
#' @description Questionnaires Disability Assessment for Dementia data frame - One record per questionnaire per question per time point per visit per subject
#' @format a data frame with 32920 rows and 23 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_qsgi
#' @description Questionnaires Alzheimer's Disease Cooperative Study-Clinical Global Impression of Change data frame - One record per questionnaire per question per time point per visit per subject
#' @format a data frame with 562 rows and 23 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_qshi
#' @description Questionnaires Modified Hachinski Ischemic Scale data frame - One record per questionnaire per question per time point per visit per subject
#' @format a data frame with 3302 rows and 23 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_qsmm
#' @description Questionnaires Mini-Mental Status Exam data frame - One record per questionnaire per question per time point per visit per subject
#' @format a data frame with 1524 rows and 23 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_qsni
#' @description Questionnaires Neuropsychiatric Inventory data frame - One record per questionnaire per question per time point per visit per subject
#' @format a data frame with 71200 rows and 23 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @format a data frame with 211 rows and 7 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
...
#' @format a data frame with 752 rows and 12 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @format a data frame with 961 rows and 10 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ RDOMAIN }}{ text - Related Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_supplbch
#' @description Supplemental Qualifiers for LB Chemistry  data frame - One record per IDVAR, IDVARVAL, and QNAM value per subject
#' @format a data frame with 37124 rows and 10 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ RDOMAIN }}{ text - Related Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_supplbhe
#' @description Supplemental Qualifiers for LB Hematology data frame - One record per IDVAR, IDVARVAL, and QNAM value per subject
#' @format a data frame with 24558 rows and 10 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ RDOMAIN }}{ text - Related Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @title sdtm_supplbur
#' @description Supplemental Qualifiers for LB Urinalysis data frame - One record per IDVAR, IDVARVAL, and QNAM value per subject
#' @format a data frame with 2721 rows and 10 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ RDOMAIN }}{ text - Related Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @format a data frame with 3559 rows and 12 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
...
#' @format a data frame with 11 rows and 10 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ ARMCD }}{ text - Planned Arm Code }
...
#' @format a data frame with 31 rows and 5 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
...
#' @format a data frame with 48 rows and 10 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
...
#' @format a data frame with 21 rows and 8 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ VISITNUM }}{ float - Visit Number }
...
#' @format a data frame with 29643 rows and 25 columns. See \url{https://github.com/SafetyGraphics/safetyData/blob/main/data-raw/sdtm/README.md} for more details and full data specification. Columns:
#' \describe{
#' \item{\code{ STUDYID }}{ text - Study Identifier }
#' \item{\code{ DOMAIN }}{ text - Domain Abbreviation }
#' \item{\code{ USUBJID }}{ text - Unique Subject Identifier }
